        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form action="{{ route('insurance.companies.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row clearfix">
                                <div class="col-5">
                                ...
                                <div class="col-3">
                                    <label for="Max Capacity">Email (<span id="text-sm">Insurance Co. Email</span>)</label>
                                    <div class="form-group">
                                        <input type="email" class="form-control" name="insurer_email" :value="old('insurer_email')" min="1">
                                        <x-input-error :messages="$errors->get('insurer_email')" class="mt-2 list-unstyled"></x-input-error>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <label for="Max Capacity">Phone Number (<span id="text-sm">Company Phone Number</span>)</label>
                                    <div class="form-group">
                                        <input type="tel" class="form-control" name="insurer_phone_number" :value="old('insurer_phone_number')" min="1">
                                        <x-input-error :messages="$errors->get('insurer_phone_number')" class="mt-2 list-unstyled"></x-input-error>
                                    </div>
                                </div>
                                <div class="col-6">
