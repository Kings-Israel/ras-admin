                            ...
                            <div class="row clearfix">
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Enter Institution's Name" name="institution_name" value="{{ $financing_institution->name }}" required autocomplete="off" />
                                ...
                                <div class="col-3">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="institution_email" value="{{ $financing_institution->email }}">
                                ...
                                <div class="col-3">
                                    ...
                                    <div class="form-group">
                                        <input type="tel" class="form-control" name="institution_phone_number" value="{{ $financing_institution->phone_number }}">
                                ...
                                <div class="col-6">
                                    ...
                                    <select name="country_id" class="form-control show-tick" id="country">
                                        ...
                                        @foreach ($countries as $country)
                                            <option value="{{ $country->id }}" @if($financing_institution->country_id == $country->id) selected @endif data-cities="{{ $country->cities }}">{{ $country->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="credit_limit" id="" class="form-control" value="{{ $financing_institution->credit_limit }}" min="10" placeholder="Enter amount limit which the financier can facilitate">
