<div>
    <ol class="flex items-center w-full space-x-2 text-sm font-medium text-center text-gray-700 bg-white rounded-lg shadow-sm dark:text-gray-400 sm:text-base dark:bg-gray-800 sm:space-x-4">
