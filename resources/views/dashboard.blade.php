                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card text-center">
                        ...
                        <div class="body" id="financing-limit" style="display: block">
                            ...
                            <h3 class="m-b-10 number count-to" data-from="0" data-to="{{ $financing_total_limit}}.00"
                                data-speed="100" data-fresh-interval="200">"{{ $financing_total_limit }}.00"
                            </h3>
                        </div>
                </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="card text-center">
                        ...
                        <div class="body" id="financing-disbursed" style="display: block">
                            ...
                            <h3 class="m-b-10 number count-to" data-from="0" data-to="{{$financing_total_invoices}}.00"
                                data-speed="100" data-fresh-interval="200">"{{$financing_total_invoices}}.00"
                            </h3>
                        </div>
                </div>
                </div>
